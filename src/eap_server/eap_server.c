				   ...
				   struct eap_config *conf)
{
	...
	sm->eap_req_id_retry_interval = conf->eap_req_id_retry_interval;
	sm->eap_aaa_req_retries = conf->eap_aaa_req_retries;
	sm->eap_aaa_req_timeout = conf->eap_aaa_req_timeout;
