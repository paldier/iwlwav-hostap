...
#define WLAN_EID_SUBELEMENT_VENDOR_SPECIFIC 221
...
#define WLAN_EID_EXT_HE_SPATIAL_REUSE_SET 39
#define WLAN_EID_EXT_HE_NDP_FEEDBACK_REPORT_PARAMETER_SET 41
...
#define WLAN_EXT_CAPAB_SSID_LIST_MASK			BIT(1)
#define WLAN_EXT_CAPAB_WNM_NOTIF_MASK			BIT(6)
...
#define HE_CHANWIDTH_USE_HT    0
#define HE_CHANWIDTH_80MHZ     1
#define HE_CHANWIDTH_160MHZ    2
#define HE_CHANWIDTH_80P80MHZ  3

#define VENDOR_HE_TYPE         0x04
#define VENDOR_HE_SUBTYPE      0x08
#define VENDOR_HE_SUBTYPE2     0x00
#define VENDOR_HE_SUBTYPE3     0x18

struct ieee80211_he_capabilities {
	u8 he_mac_capab_info[6];
	u8 he_phy_capab_info[11];
	u8 he_txrx_mcs_support[12];
	u8 he_ppe_thresholds[13];
} STRUCT_PACKED;
...
struct ieee80211_he_operation {
	...
	u8 he_6gh_operation_information[4];
} STRUCT_PACKED;
...
struct ieee80211_he_spatial_reuse_parameter_set {
	u8 he_sr_control;
	u8 he_non_srg_obss_pd_max_offset;
	u8 he_srg_obss_pd_min_offset;
	u8 he_srg_obss_pd_max_offset;
	u8 he_srg_bss_color_bitmap[8];
	u8 he_srg_partial_bssid_bitmap[8];
} STRUCT_PACKED;

/* IEEE 802.11AX DRAFT VER 4.0 */
...
#define HE_MCS_NSS_RX_MCS_MAP_80P_80_MHZ_PART1_IDX 8
#define HE_MCS_NSS_TX_MCS_MAP_80P_80_MHZ_PART1_IDX 10
...
#define HE_OPERATION_CAP2_ER_SU_DISABLE ((u8) BIT(0))
#define HE_OPERATION_CAP2_6GHZ_OPERATION_INFO_PRESENT ((u8) BIT(1)) /* B17 */
/* B18 ...B23 Reserved */

/* HE BSS Color Information field defines */
#define HE_OPERATION_CAP3_IDX 3
...
/* HE 6GHz Operation information control field defines */
#define HE_OPERATION_6GHZ_CONTROL_CHANNEL_WIDTH ((u8) (BIT(0) | BIT(1)))
/* B2 ...B7 Reserved */

/* HE MU AC parameter record field format */
#define HE_MU_AC_PARAM_ACI_AIFSN_IDX 0
...
#define HE_MU_AC_PARAM_ECWMIN_ECWMAX_IDX 1
#define HE_MU_AC_PARAM_ECWMAX ((u8) (BIT(0) | BIT(1) | BIT(2) | BIT(3)))
#define HE_MU_AC_PARAM_ECWMIN ((u8) (BIT(4) | BIT(5) | BIT(6) | BIT(7)))

#define HE_MU_AC_PARAM_MU_EDCA_TIMER_IDX 2
...
/* HE Spatial Reuse Parameter SR Control field format */
#define HE_SRP_DISALLOWED (u8) BIT(0)
#define HE_SRP_NON_SRG_OBSS_PD_SR_DIS (u8) BIT(1)
#define HE_SRP_NON_SRG_OFFSET_PRESENT (u8) BIT(2)
#define HE_SRP_SRG_INFO_PRESENT (u8) BIT(3)
#define HE_SRP_HESIGA_SPATIAL_REUSE_VAL15_ALLOW (u8) BIT(4)
/* B5 ...B7 Reserved */
...
/* BIT(5)..BIT(12), i.e., B13..B20 - Channel Center Frequency Segment 2 */
#define HT_OPER_OP_MODE_CHANNEL_CENTER_FREQUENCY_SEGMENT_TWO	\
  ((u16) (BIT(5) | BIT(6) | BIT(7) | BIT(8) | BIT(9) | BIT(10) | BIT(11) | BIT(12))) /* B13..B20 */
/* BIT(13)..BIT(15), i.e., B21..B23 - Reserved */
...
#define BSS_MEMBERSHIP_SELECTOR_HE_PHY 123
...
#define WLAN_EID_SUPP_RATES_MAX_LEN 8
#define WLAN_EID_CHALLENGE_MAX_LEN 253
#define WLAN_EID_MESH_CONFIG_LEN 7
#define WLAN_EID_MESH_ID_MAX_LEN 32
#define WLAN_EID_PEER_MGMT_MAX_LEN 24
#define WLAN_EID_LINK_ID_LEN 18
#define WLAN_EID_INTERWORKING_MAX_LEN 9
#define WLAN_EID_EXT_CAPAB_MAX_LEN 10
#define WLAN_EID_RRM_ENABLED_CAPABILITIES_LEN 5
#define FTIE_SUBELEM_GTK_MAX_LEN 51
#define FTIE_SUBELEM_IGTK_MAX_LEN 33


/* Definitions as per IEEE 802.11ai - 2016 amendment - chapter 9.4.2 for frame validation */
#define WLAN_EID_DILS_MAX_LEN 4
#define WLAN_EID_EXT_FILS_REQ_PARAMS_MAX_LEN 10

/* Definitions as per WFA HS 2.0 v3.1 - chapter 3.1 doc for frame validation */
#define HS20_INDICATION_OUI_TYPE_MAX_LEN 7
#define HS20_ROAMING_CONS_SEL_OUI_TYPE_MAX_LEN 9
