		 ...
		 const char *identity, const char *radius_cui)
{
	...
	eap_conf.eap_req_id_retry_interval = eapol->conf.eap_req_id_retry_interval;
	eap_conf.eap_aaa_req_retries = eapol->conf.eap_aaa_req_retries;
	eap_conf.eap_aaa_req_timeout = eapol->conf.eap_aaa_req_timeout;
				 ...
				 struct eapol_auth_config *src)
{
	...
	dst->eap_req_id_retry_interval = src->eap_req_id_retry_interval;
	dst->eap_aaa_req_retries = src->eap_aaa_req_retries;
	dst->eap_aaa_req_timeout = src->eap_aaa_req_timeout;
	dst->auth_quiet_period = src->auth_quiet_period;
